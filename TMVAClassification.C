...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   TFile *input(0);
   TString fname = "RootFiles/splitMC.root";
   ...
   TTree *signalTree     = (TTree*)input->Get("SignalTrain");
   TTree *background     = (TTree*)input->Get("BackgroundTrain");
   ...
   dataloader->AddVariable( "mll", "mll", "units", 'F' );
   dataloader->AddVariable( "lead", "lead", "units", 'F' );
   dataloader->AddVariable( "sublead", "sublead", "units", 'F' );
